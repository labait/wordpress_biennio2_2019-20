...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style('font-dosis', 'https://fonts.googleapis.com/css2?family=Dosis&display=swap', array(), $the_theme->get('Version'));
    wp_enqueue_style('font-poppins', 'https://fonts.googleapis.com/css2?family=Poppins&display=swap', array(), $the_theme->get('Version'));
